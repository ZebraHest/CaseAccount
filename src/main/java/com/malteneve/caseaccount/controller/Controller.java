...
public class Controller {
	...
	@GetMapping("/create")
	public ReturnData createAccount(@RequestParam(value="name") String name, @RequestParam(value="amount", defaultValue = "0") Double amount) {
	...
	@GetMapping("/transfer")
	public ReturnData transferAmount(@RequestParam(value="fromId") String fromId, @RequestParam(value="toId") String toId, @RequestParam(value = "amount") Double amount){
